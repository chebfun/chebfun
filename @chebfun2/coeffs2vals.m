...
%
% V = COEFFS2VALS( C ) converts a matrix C of bivariate Chebyshev 
% coefficients to a matrix of samples V corresponding to values of 
% sum_i sum_j C(i,j) T_{i-1}(y)T_{j-1}(x) at a tensor Chebyshev grid of 
% size size(C). 
% 
