function g = extract_diskfun(f, a, b, varargin)
% EXTRACT_DISKFUN is the intersection between a BALLFUN function and a
%   plane
%   EXTRACT_DISKFUN(f, lambda, theta, r) is the slice of the BALLFUN function f
...
for i = 1:m
    for j = 1:n
        ...
        vec_0 = MrotationZ*MrotationX*vec_ij;
