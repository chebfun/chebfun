...
%   the same.  If these grids are used, it is best to call chebtech1.bary() and
%   chebtech2.bary() instead of this function, as these set the scaling factor
%   automatically.
%
%   Example:
%     xcheb = chebtech2.chebpts(14);
%     vcheb = chebtech2.barywts(14);
%     fx = 1./( 1 + 25*xcheb.^2 );
%     xx = linspace(-1, 1, 1000);
%     [xx, yy] = meshgrid(xx, xx);
%     ff = chebtech.bary(xx + 1i*yy, fx, xcheb, vcheb, [], 1/(2*(14 - 1)));
...
%
% See also CHEBTECH.CHEBPTS, CHEBTECH.BARYWTS, CHEBTECH.FEVAL.
