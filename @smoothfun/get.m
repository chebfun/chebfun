...
%GET    GET method for the SMOOTHFUN class
...
switch prop
    ...
    case {'points', 'lval', 'rval', 'ishappy',' vscale', 'epslevel'}
        out = get(f.funcheb, prop);
    otherwise
        error('CHEBFUN:SMOOTHFUN:GET:proname', ...
            'Unknown property name ''%s'' for object of type smoothfun.', prop);
end