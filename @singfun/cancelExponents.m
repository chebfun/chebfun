...
%   F = SIMPLIFYEXPONENTS(F) returns a SINGFUN whose smoothPart has no vanishing 
%   value at the boundaries if the corresponding exponents are negative. 
%   Boundary roots are tried to be extracted off from the smoothPart at the 
%   corresponding boundary to cancel the partial or entire exponents. 
%
