...
%   above or below the unit sphere. A contour plot are the level curves of
%   F for some values V. The values V are chosen automatically.
%
...
%   plot on an 200-by-200 grid.
%
%   CONTOUR(F, 'PIVOTS', STR) plots the contour lines with the pivot
%   locations used during constructor.  STR should indicate the marker to
%   be used for the pivots (see PLOT for options).
%
% See also PLOT.
