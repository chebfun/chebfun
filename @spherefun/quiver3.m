...
%QUIVER3  3-D quiver plot of a CHEBFUN2V at data mapped by a SPHEREFUN.
%
% QUIVER3(Z, F) plots velocity vectors at the equally spaced surface point
% specified by the SPHEREFUN Z. We use Z to map a uniform grid. F should be
% a CHEBFUN2V.
%
% QUIVER3(X, Y, Z, F) plots velocity vectors at (x,y,z), where X, Y, Z are
% SPHEREFUN objects which we use to to map a uniform grid. F should be a
% CHEBFUN2V.
%
...
% SPHEREFUN methods take priority over CHEBFUN2V methods.
%
