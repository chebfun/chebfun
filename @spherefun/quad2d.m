...
%QUAD2D  Complete definite integral of SPHEREFUN2. 
%   I = QUAD2D( F ), returns the definite integral of a SPHEREFUN2 integrated
%   over its domain of definition.
% 
%   I = QUAD2D(F, a, b, c, d), returns the definite integral of a SPHEREFUN2.
