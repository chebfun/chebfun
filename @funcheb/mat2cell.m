...
%MAT2CELL  Convert a vector-valued FUNCHEB into an ARRAY of FUNCHEB objects.
%
%   G = MAT2CELL(F, C) breaks up the vector-valued FUNCHEB F into a single row
%   cell array G of FUNCHEB objects. C is the vector of column sizes, and if F
...
if ( ~isscalar(M) || M ~= 1)
    error('CHEBFUN:FUNCHEB:mat2cell:size', ...
