...
%   PREF.FUNCHEB.tech, as above. FUNCHEB.CONSTRUCTOR({VALUES, COEFFS}, ...)
%   allows for the corresponding Chebyshev coefficients to be passed also, and
%   if VALUES is empty the FUNCHEB is constructed directly from the COEFFS.
%
% Examples:
%   % Basic construction:
...
%
% There are two concrete realizations of the FUNCHEB class--FUNCHEB1 and
% FUNCHEB2--which interpolate on Chebyshev grids of the 1st and 2nd kind,
...
% See http://www.chebfun.org/ for Chebfun information.
    ...
    properties ( Access = public )
        ...
        % Vertical scale of the FUNCHEB. This is a row vector storing the
