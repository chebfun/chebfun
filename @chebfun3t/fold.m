...
%FOLD     Reshapes a matrix to get a tensor.
%
...
%
%   T = FOLD(A, SIZET, ROWDIMS) chooses COLDIMS automatically to
%   contain all dimensions not contained in ROWDIMS. The entries of
%   COLDIMS are arranged in ascending order.
%
%   Example:
%   A = randn(15, 8);
%   T = fold(A, [2 3 4 5], [2 4]) % returns a 2x3x4x5 tensor
%   
