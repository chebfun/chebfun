...
%ROOTS   Roots of a FOURIERTECH in the interval [-pi,pi].
%   ROOTS(F) returns the real roots of the FOURIERTECH F in the interval [-pi,pi].
%
...
%
%   If F is an array-valued FOURIERTECH then there is no reason to expect each
