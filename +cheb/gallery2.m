...
%   F = GALLERY2(NAME) returns a chebfun2 corresponding to NAME. See the
...
%
%   [F,FA] = GALLERY2(NAME) also returns the anonymous function FA used to
...
%
%   GALLERY2 with no input argument returns a random function from the
%   gallery.
%
%   GALLERY2 with no output argument creates a plot of the selected function.
%
