...
pass(4) = norm(funcheb2.chebpoly(funcheb2.clenshaw(funcheb2.chebpts(9), c0)) - c2, inf) < tol;
pass(5) = norm(funcheb2.chebpoly(funcheb2.clenshaw(funcheb2.chebpts(3), c0)) - c3, inf) < tol;
...
% Compare against result of evaluating on a smaller grid:
pass(9) = norm(funcheb2.chebpoly(funcheb2.clenshaw(funcheb2.chebpts(9), cc)) - c2, inf) < tol;
pass(10) = norm(funcheb2.chebpoly(funcheb2.clenshaw(funcheb2.chebpts(3), cc)) - c3, inf) < tol;
