...
pass(4) = norm(chebtech2.chebpoly(chebtech.clenshaw(chebtech2.chebpts(9), c0)) - c2, inf) < tol;
pass(5) = norm(chebtech2.chebpoly(chebtech.clenshaw(chebtech2.chebpts(3), c0)) - c3, inf) < tol;
...
% Compare against result of evaluating on a smaller grid:
pass(9) = norm(chebtech2.chebpoly(chebtech.clenshaw(chebtech2.chebpts(9), cc)) - c2, inf) < tol;
pass(10) = norm(chebtech2.chebpoly(chebtech.clenshaw(chebtech2.chebpts(3), cc)) - c3, inf) < tol;
...
v0 = chebtech2.chebpolyval(c0);
v2 = chebtech2.bary(chebtech2.chebpts(n), v0);
c2 = chebtech2.chebpoly(v2);
