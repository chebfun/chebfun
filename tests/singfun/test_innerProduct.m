...
pass(1) = ( abs(I-I_exact) < 10*max(eps, eps)*...
    abs(I_exact) );
...
pass(3) = ( abs(I-I_exact) < 1e1*max(eps, eps)*...
    abs(I_exact) );
...
pass(4) = ( abs(I-I_exact) < 1e1*max(eps, eps)*...
    abs(I_exact) );
...
pass(5) = ( abs(I-I_exact) < 1e1*max(eps, eps)*...
    abs(I_exact) );
...
pass(6) = ( abs(I-I_exact) < 1e1*max(eps, eps) );
...
pass(7) = ( abs(I-I_exact) < 1e1*max(eps, eps)*...
    abs(I_exact) );
...
pass(8) = ( abs(I-I_exact) < 1e1*max(eps, eps)*...
    abs(I_exact) );
