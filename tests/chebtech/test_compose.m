...
for n = 1:4
    ...
    pass(n, 1) = norm(h.coeffs - g.coeffs, inf) < 10*h.vscale.*eps;
    ...
    pass(n, 5) = norm(hvalues - gvalues, inf) < 10*h.vscale.*eps;
    ...
    pass(n, 7) = norm(hvalues - sin(x.^2), inf) < 10*h.vscale.*eps;
