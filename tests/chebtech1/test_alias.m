...
pass(4) = norm(chebtech1.vals2coeffs(chebtech.clenshaw(chebtech1.chebpts(9), c0)) - c2, inf) < tol;
pass(5) = norm(chebtech1.vals2coeffs(chebtech.clenshaw(chebtech1.chebpts(3), c0)) - c3, inf) < tol;
...
% Compare against result of evaluating on a smaller grid:
pass(9) = norm(chebtech1.vals2coeffs(chebtech.clenshaw(chebtech1.chebpts(9), cc)) - c2, inf) < tol;
pass(10) = norm(chebtech1.vals2coeffs(chebtech.clenshaw(chebtech1.chebpts(3), cc)) - c3, inf) < tol;
