...
pass(2) = all(size(x) == [n, 1]) && all(size(w) == [n, 1]) && all(size(v) == [n, 1]);
...
pass(7) = abs(w'*x - 30.1957169274024) < 10*tol && abs(w'*x.^2 - 209.0472710358626) < 100*tol;
...
[x, w, v] = ultrapts(n, lambda);
pass(12) = all(size(x) == [n, 1]) && all(size(w) == [n, 1]) && all(size(v) == [n, 1]);
...
pass(22) = all(size(x) == [n, 1]) && all(size(w) == [n, 1]) && all(size(v) == [n, 1]);
