...
fp = op(y);
rhs = [op(dom(1)); fp];
D = diffmat([M N], p, dom, 'colloc1', {'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(19) = ( err < tol );
...
D = diffmat([M N], p, dom, 'colloc1', {'dirichlet'}, {'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(21) = ( err < 1e1*tol );
...
D = diffmat([M N], p, dom, 'colloc1', {'dirichlet' 'neumann'}, {});
ff = D\rhs;
err = norm(ff-f, inf);
pass(22) = ( err < 1e2*tol );
...
D = diffmat([M N], p, dom, 'colloc1', {}, {'neumann' 'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(23) = ( err < 1e1*tol );
...
D = diffmat([M N], p, dom, 'colloc1', {'neumann'}, {'sum'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(26) = ( err < 1e1*tol );
...
fp = op(y);
rhs = [op(dom(1)); fp];
D = diffmat([N -p], p, dom, 'colloc2', {'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(27) = ( err < tol );
...
fp = op(y);
rhs = [op(dom(1)); fp; op(dom(2))];
D = diffmat([M N], p, dom, 'colloc2', {'dirichlet'}, {'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(29) = ( err < 1e1*tol );
...
fp = op(y);
rhs = [op(dom(1)); op(dom(1)); fp];
D = diffmat([M N], p, dom, 'colloc2', {'dirichlet' 'neumann'}, {});
ff = D\rhs;
err = norm(ff-f, inf);
pass(30) = ( err < 1e2*tol );
...
fp = op(y);
rhs = [fp; op(dom(2)); op(dom(2))];
D = diffmat([M N], p, dom, 'colloc2', {}, {'neumann' 'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(31) = ( err < 1e2*tol );
...
D = diffmat([M N], p, dom, 'colloc2', {}, {'sum' 'dirichlet'});
ff = D\rhs;
err = norm(ff-f, inf);
pass(34) = ( err < 1e1*tol );
