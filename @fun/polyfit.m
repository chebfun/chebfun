...
%POLYFIT   Fit polynomial to a FUN.
%   F = POLYFIT(Y, N) returns a FUN F corresponding to the polynomial of
%   degree N that fits the FUN Y in the least-squares sense.
%
%   Note FUN/POLYFIT does not not support more than one output argument in
