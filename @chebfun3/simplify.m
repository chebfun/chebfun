...
% SIMPLIFY   Simplify for CHEBFUN3 objects. 
...
%   the core tensor becomes smaller. The number of columns in the factor
%   quasimatrices are adjusted accordingly. Note that unlike the 2D case 
%   where truncation by SVD gives optimal low rank approximation, 
%   this is not necessarily true in dimensions higher than 2. However, this
%   usually gives a good approximation to the best tensor of the 
%   correpsonding rank.
%
