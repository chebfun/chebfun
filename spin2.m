...
%       u = spin('GL2');
%
%    solves the Ginzburg-Landau equation on [0 200]^2 from t=0 to t=150, with a
...
%       u = spin('GS2');
%
%    solves the Gray-Scott equations on [0 1.25]^2 from t=0 to t=3200, with 
%    initial condition 
%
...
%       u = spin('Schnak2');
%
%    solves the Schnakenberg equations on [0 50]^2 from t=0 to t=300, with 
%    initial condition 
%
...
%       u = spin('SH2');
%
%    solves the Swift-Hohenberg equation on [0 50]^2 from t=0 to t=200, with a
%    random initial condition.
%
