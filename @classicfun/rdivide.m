...
% TODO: CLASSICFUN/RDIVIDE() should check for roots at the ends of the domain. If any
...
elseif ( isa(f, 'double')  )    % DOUBLE ./ CLASSICFUN
    ...
    % Both f and g are CLASSICFUN objects. Call RDIVIDE() on their onefuns. Similar to
