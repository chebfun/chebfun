classdef classicfun % (Abstract)
%CLASSICFUN   Represent global non-generalized functions on an interval [a, b].
%
...
%
% The CLASSICFUN class is an abstract class for representations of CLASSICFUNctions on the
