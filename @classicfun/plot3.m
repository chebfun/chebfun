...
%PLOT3   Plot for CLASSICFUN objects in 3-D space. 
%   PLOT() is a three-dimensional analogue of PLOT().
%   
%   PLOT3(X, Y, Z), where Z, Y, and Z are three CLASSICFUN objects, plots a line in
...
%   objects, one handle per plotted line (in the case of vector-valued CLASSICFUN
