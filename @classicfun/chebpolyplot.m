...
%   plots the Chebyshev coefficients of the ONEFUN of a CLASSICFUN F on a semilogy
%   scale. A horizontal line at the EPSLEVEL of F.ONEFUN is also plotted. If F
%   is an array-valued CLASSICFUN then a curve is plotted for each component (column) 
%   of F.
%
