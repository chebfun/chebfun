...
%   condition U0 for time T through the differential equation u' = L*u,
%   where L is a linop. Formally, the solution is given by u(t) =
%   exp(t*L)*u0, where exp(t*L) is a semigroup generated by L.
%
