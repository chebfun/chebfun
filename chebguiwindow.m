...
%%%%%%%%%%%%%%%%%%%%%%%%%% Developers note %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This method implements most callback method of CHEBGUI, i.e., methods that get
% executed when the user interacts with the GUI figure. Many of these methods
% are automatically generated by MATLAB, which explains why a lot of them have
% input arguments that appear to be unused (but are needed for the calling
% mechanism of MATLAB).
%
...
% Developers note:
%   contents = cellstr(get(hObject,'String')) returns iter_list contents as cell
%       array
...
% Developers note: Most of these are automatically created by MATLAB.
...
% -------------------------------------------------------------------------
% These methods will open the CHEBGUIEDIT sub-GUI
