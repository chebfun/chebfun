...
handles.panel_domain = uipanel('Parent', handles.panel_input, ...
    ...
    'Position', [panelLeftMargin 3*panelHeight + bottomPanelMargin .45 .11], 'FontSize', textFontsize, ...
    'BorderType', 'etchedin');
...
handles.panel_timedomain = uipanel('Parent', handles.panel_input, ...
    ...
    'BackgroundColor', textBackgroundColour, ...
    'Position', [.525+panelLeftMargin 3*panelHeight + bottomPanelMargin .45 .11], 'FontSize', textFontsize, ...
