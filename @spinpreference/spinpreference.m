...
% See http://www.chebfun.org/ for Chebfun information.
    ...
    properties ( Access = public )
        ...
        iterPlot             % Plot every ITERPLOT iterations (1x1 DOUBLE)
        M                    % Number of points for complex means (1x1 DOUBLE)
        N                    % Number of points for space-grid (1x1 DOUBLE)
        Nmin                 % Min. # of pts for apative space-grid (1x1 DOUBLE)
        Nmax                 % Max. # of pts for apative space-grid (1x1 DOUBLE)
