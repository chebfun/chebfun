...
% class, such as cos, exp and sin. It constructs the corresponding syntax tree,
% where the appropriate method is at the top, and the current syntax tree up to
...
%   TREEIN: A MATLAB struct for representing the syntax tree of a mathematical
