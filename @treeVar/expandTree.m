...
elseif ( any(strcmp(tree.method, {'plus', 'minus'})) )
    ...
    % Find out what kind of argument we're dealing with for the left argument of
    % the operator
    ...
    % Split up the right tree depending on how many childs it has. In case we
    ...
    % indicates whether the right tree had to be splitted:
    if ( rightNumArgs == 0 || ...
