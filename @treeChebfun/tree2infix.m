...
switch tree.numArgs
    ...
    case 1
        [tempOut, varCounter, varArray] = ...
            treeChebfun.tree2infix(tree.center, varCounter, varArray);
    ...
    case 2
        ...
        if ( isstruct(tree.left) )
            [leftInfix, varCounter, varArray] = ...
                treeChebfun.tree2infix(tree.left, varCounter, varArray);
        else
        ...
        if ( isstruct(tree.right) )
            [rightInfix, varCounter, varArray] = ...
                treeChebfun.tree2infix(tree.right, varCounter, varArray);
        else
            varName = sprintf('var%i', varCounter);
            rightInfix = varName;
