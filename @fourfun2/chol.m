...
%CHOL    Cholesky factorization of a fourfun2. 
%
% R = CHOL( F ), if F is a nonnegative definite fourfun2 then this 
...
%
% L = CHOL(F, 'lower'), if F is a nonnegative definite fourfun2 then this
...
% and R'*R is a rank p nonnegative definite fourfun2 that approximates F. 
...
% Is the fourfun2 on a square domain?: 
