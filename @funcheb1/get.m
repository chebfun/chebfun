...
%GET    GET method for the FUNCHEB1 class
...
switch prop
    ...
    case 'points'
        ...
        out = funcheb1.chebpts(size(f.values,1));
    case 'lval'
        % The value at -1.
    ...
    case 'rval'
        ...
        out = f.bary(1, f.values);
    otherwise
        error('CHEBFUN:FUNCHEB1:GET:proname', ...
            'Unknown property name ''%s'' for object of type funcheb1.', prop);
end