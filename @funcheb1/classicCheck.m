...
%CLASSICCHECK  Attempt to trim trailing Chebyshev coefficients in a FUNCHEB1.
...
%
%   HAPPINESSREQUIREMENTS defines what it means for a FUNCHEB1 to be happy.
%   [TESTLENGTH, EPSLEVEL] = HAPPINESSREQUIREMENTS(VALUES, COEFFS, VSCALE, PREF)
%   returns two scalars TESTLENGTH and EPSLEVEL. A FUNCHEB1 is deemed to be
...
%                   vscale and pref.funcheb1.hscale).
%       * pref.funcheb1.eps
%
...
%HAPPINESSREQUIREMENTS   Define what it means for a FUNCHEB1 to be happy.
...
epslevel = max([pref.funcheb1.eps, gradErr, tailErr]);
