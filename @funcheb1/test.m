...
%TEST   Test the FUNCHEB1 class.
%   FUNCHEB1.TEST() runs the tests for the FUNCHEB1 class in the test/funcheb1/
%   folder. FUNCHEB1.test(PREF) overrides the default FUNCHEB1 preferences with
%   those in given in the preference structure PREF. P = FUNCHEB1.TEST returns a
...
% Navigate to the funcheb1 test directory and choose the files to run:
funcheb1Dir = fileparts(which('funcheb1'));         % Locate funcheb1.
loc = find(funcheb1Dir == filesep, 1, 'last');      % Go down a directory.
testDir = fullfile(funcheb1Dir(1:loc), 'tests', 'funcheb1'); % Test directory.
