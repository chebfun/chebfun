...
%   is a finite difference along the columns of a vectorised FUNCHEB2.
%   If F has L columns, an empty FUNCHEB2 will be returned for K > L.
%
% See also SUM, CUMSUM.
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% If the funcheb2 G of length n is represented as
%       SUM_{r=0}^{n-1} C_r T_r(x)
% its derivative is represented with a funcheb2 of length n-1 given by
