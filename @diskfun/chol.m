...
% i nonnegative definite then p is 0 and R is the same as above. If F is
...
% definite DISKFUN that approximates F. This is particular useful when F is
% nonnegative definite, but rounding error have perturbed it to be
% semidefinite.
%
