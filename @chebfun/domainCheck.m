...
%   scales or if both F and G are empty CHEBFUN objects.  The CHEBFUN class
%   uses this function internally to compare the domains of CHEBFUN objects
%   before attempting to perform operations on multiple CHEBFUNs that require
%   the CHEBFUNs to reside on the same interval.
