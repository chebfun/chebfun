...
%CHEBCOEFFSPLOT   Display Chebyshev coefficients graphically.
%   CHEBCOEFFSPLOT(F) plots the Chebyshev coefficients of a CHEBFUN F on a
...
for k = 1:numel(f)
    ...
    [h1{k}, h2{k}] = columnChebcoeffsplot(fk, colk, varargin{:});
    hold on
...
function [h1, h2] = columnChebcoeffsplot(f, col, varargin)
