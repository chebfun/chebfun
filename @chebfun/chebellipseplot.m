...
%   piecewise part of U, with foci at points in U.domain and semi-minor
%   and major axes summing to rho(k) = C*exp(abs(log(EPS))/N(k)), where
%   C is the appropriate scaling for the interval [U.ends(k) U.ends(k+1)]
%   and EPS is the EPSLEVEL of U.
%
