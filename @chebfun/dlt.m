...
% We current call chebfun.ndct for this, but here is the old way to do it.
% We keep this code below in case it is decided that it is faster than the
% more general chebfun.ndct algorithm. 
% 
% function v = ndct( c )
