...
%                     N.rbc = []; %#ok<MCSUP>  
        ...
        %   CHEBOP.SET.INIT offers more control of setting the initial guess for
        %   the Newton solves used for nonlinar ODES than simply accessing the
        %   .init field, or using standard subsref. In particular, it checks
